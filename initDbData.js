...
Object.keys(userList).map(async (user) => {
    ...
    var insert = await insertTableUser.query(`
        ...
        VALUES (${userInfor.userid}, ${userInfor.username_user}, ${userInfor.password_user}, ${userInfor.email}, ${userInfor.phone}, ${userInfor.phoneActive}, ${userInfor.fullName}, ${userInfor.dateOfBirth}, ${userInfor.gender}, ${userInfor.createDate}, ${userInfor.avatar_path}, ${userInfor.bio}, ${userInfor.activenow}, ${userInfor.lastActive})
    `);
